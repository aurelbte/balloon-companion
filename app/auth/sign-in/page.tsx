        ...
        >
          <label className={styles.field}>
            ...
            <input
              ...
              onChange={(event) => { setDraft((current) => ({ ...current, email: event.target.value })); setSubmitError(null); }}
            />
          ...
          <label className={styles.field}>
            ...
            <input
              ...
              onChange={(event) => { setDraft((current) => ({ ...current, password: event.target.value })); setSubmitError(null); }}
            />
            <small id="password-error" className={styles.error}>{touched.password ? validation.errors.password ?? "\u00a0" : "\u00a0"}</small>
          </label>
          <Link className={styles.forgot} href="/auth/forgot-password">Mot de passe oublié ?</Link>
