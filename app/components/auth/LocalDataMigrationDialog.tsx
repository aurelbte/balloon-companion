...
export default function LocalDataMigrationDialog() {
  ...
  if (!visible) return actionRequired ? <aside className={styles.notice} role="status" title={auth.localDataImportNotice ?? undefined}><span>Données à vérifier</span><Link href="/more/cloud-sync">Voir les détails</Link></aside> : null;
