...
export const QUALIFICATION_EVENT_LABELS: Readonly<Record<QualificationEventType, string>> = Object.freeze({
  ...
  INITIAL_COMMERCIAL_ISSUANCE: "Délivrance initiale — activité commerciale passagers",
  COMMERCIAL_PROFICIENCY_CHECK: "Contrôle de compétences commercial",
  OPERATOR_PROFICIENCY_CHECK: "Contrôle de compétences opérateur",
  COMMERCIAL_REFRESHER_COURSE: "Formation / remise à niveau commerciale",
  FI_B_REFRESHER_TRAINING: "Remise à niveau instructeur FI(B)",
  FI_B_SUPERVISED_INSTRUCTION: "Instruction FI(B) sous supervision",
  FI_B_ASSESSMENT_OF_COMPETENCE: "Évaluation de compétences FI(B)",
  FE_B_CERTIFICATE: "Certificat FE(B)",
  FE_B_REFRESHER_COURSE: "Remise à niveau examinateur FE(B)",
  FE_B_SUPERVISED_ASSESSMENT: "Acte FE(B) sous supervision",
