...
export default function UnitsPage() {
  ...
  return <main className={styles.screen}><div className={styles.layout}>
    ...
    <header className={styles.header}><p>Réglages de l’app</p><h1>Unités</h1></header>
    <section className={styles.unitSection}><h2>Météo</h2>
    ...
    <section className={styles.unitSection}><h2>Instruments de vol</h2>
