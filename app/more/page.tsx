...
export default function MorePage() {
  return <main className={styles.screen}><div className={styles.layout}>
    ...
    <Link href="/auth" className={styles.card}><div><h2>Compte Balloon Companion</h2><p>Connexion facultative et identité du pilote</p></div><ChevronRight size={18} aria-hidden="true" /></Link>
