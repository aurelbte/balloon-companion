  ...
  return (
    <main className={styles.screen}>
      <div className={styles.layout}>
        ...
        <Button className={styles.cta} href="/prepare" onClick={startNewPreparationSession} fullWidth aria-label="Préparer mon vol"><ClipboardCheck size={19} aria-hidden="true" />Préparer mon vol</Button>
