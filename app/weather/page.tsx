...
import { ArrowLeft, ChevronLeft, ChevronRight, Cloud, CloudDrizzle, CloudFog, CloudHail, CloudLightning, CloudRain, CloudSun, Droplets, Eye, Moon, Navigation, Snowflake, Star, Sun, Sunrise } from "lucide-react";
...
const ICONS = { CLEAR: Sun, MAINLY_CLEAR: CloudSun, PARTLY_CLOUDY: CloudSun, OVERCAST: Cloud, FOG: CloudFog, RIME_FOG: CloudFog, LIGHT_DRIZZLE: CloudDrizzle, MODERATE_DRIZZLE: CloudDrizzle, DENSE_DRIZZLE: CloudDrizzle, LIGHT_FREEZING_DRIZZLE: CloudDrizzle, DENSE_FREEZING_DRIZZLE: CloudDrizzle, LIGHT_RAIN: CloudRain, MODERATE_RAIN: CloudRain, HEAVY_RAIN: CloudRain, LIGHT_FREEZING_RAIN: CloudRain, HEAVY_FREEZING_RAIN: CloudRain, LIGHT_SNOW: Snowflake, MODERATE_SNOW: Snowflake, HEAVY_SNOW: Snowflake, SNOW_GRAINS: Snowflake, LIGHT_RAIN_SHOWERS: CloudRain, MODERATE_RAIN_SHOWERS: CloudRain, VIOLENT_RAIN_SHOWERS: CloudRain, LIGHT_SNOW_SHOWERS: Snowflake, HEAVY_SNOW_SHOWERS: Snowflake, THUNDERSTORM: CloudLightning, THUNDERSTORM_LIGHT_HAIL: CloudHail, THUNDERSTORM_HEAVY_HAIL: CloudHail, UNKNOWN: Cloud } satisfies Record<NormalizedWeatherCode, typeof Sun>;
const WEATHER_LABELS: Record<NormalizedWeatherCode, string> = { CLEAR: "Ciel dégagé", MAINLY_CLEAR: "Principalement dégagé", PARTLY_CLOUDY: "Peu nuageux", OVERCAST: "Couvert", FOG: "Brouillard", RIME_FOG: "Brouillard givrant", LIGHT_DRIZZLE: "Bruine faible", MODERATE_DRIZZLE: "Bruine modérée", DENSE_DRIZZLE: "Bruine forte", LIGHT_FREEZING_DRIZZLE: "Bruine verglaçante faible", DENSE_FREEZING_DRIZZLE: "Bruine verglaçante forte", LIGHT_RAIN: "Pluie faible", MODERATE_RAIN: "Pluie modérée", HEAVY_RAIN: "Pluie forte", LIGHT_FREEZING_RAIN: "Pluie verglaçante faible", HEAVY_FREEZING_RAIN: "Pluie verglaçante forte", LIGHT_SNOW: "Neige faible", MODERATE_SNOW: "Neige modérée", HEAVY_SNOW: "Neige forte", SNOW_GRAINS: "Neige en grains", LIGHT_RAIN_SHOWERS: "Averses faibles", MODERATE_RAIN_SHOWERS: "Averses modérées", VIOLENT_RAIN_SHOWERS: "Averses violentes", LIGHT_SNOW_SHOWERS: "Averses de neige faibles", HEAVY_SNOW_SHOWERS: "Averses de neige fortes", THUNDERSTORM: "Orage", THUNDERSTORM_LIGHT_HAIL: "Orage avec faible grêle", THUNDERSTORM_HEAVY_HAIL: "Orage avec forte grêle", UNKNOWN: "Conditions inconnues" };
