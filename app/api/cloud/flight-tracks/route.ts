...
import { createR2DownloadUrl, createR2UploadUrl, deleteR2Track, migrateLegacyFlightTrackToR2 } from "../../../lib/flightTrackR2Server.ts";
...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    if (body.action === "UPLOAD_URL") return Response.json(await createR2UploadUrl(target, { sizeBytes: body.sizeBytes, checksum: body.checksum }));
